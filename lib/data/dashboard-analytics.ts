...
export const BOT_DASHBOARD_LISTINGS: BotDashboardListing[] = [
  {
    ...
    bannerHue: "0", publicPath: "/bots/shield-mod", prefix: "/", avatar: botAvatar("shield-mod"), galleryImages: [],
    safetyStatus: "PENDING_REVIEW",
  ...
  },
  {
    ...
    bannerHue: "185", publicPath: "/bots/helper-ai", prefix: "/", avatar: botAvatar("helper-ai"), galleryImages: [],
    safetyStatus: "PENDING_REVIEW",
  ...
  },
  {
    ...
    bannerHue: "45", publicPath: "/bots/economy-pro", prefix: "!", avatar: botAvatar("economy-pro"), galleryImages: [],
