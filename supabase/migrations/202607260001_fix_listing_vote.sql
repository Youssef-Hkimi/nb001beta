...
begin
  ...
  set votes_count = l.votes_count + 1
  where l.id = p_listing_id
  returning l.votes_count into updated_count;
...
revoke all on function public.cast_listing_vote(uuid, uuid, text) from public;
grant execute on function public.cast_listing_vote(uuid, uuid, text) to service_role;
